...
class Programmer
{
    ...
    // @Assert\NotBlank annotation is adding validation to this property, meaning that when a new programmer resource is created, this property cannot be left blank.
    // By adding this validation, if the user does not add a nickname, then they will get a clear error message that they can understand.
    /**
     * @var string
     *
